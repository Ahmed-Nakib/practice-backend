...
// @CHALLENGE: Harden `OrderService` for production-like concerns
// - decide where to handle and propagate errors (throw vs return values)
// - ensure read/write failures are surfaced to callers and tested
// - add input validation and return the created/updated entity where appropriate
// - consider concurrent access to the JSON file (race conditions)
class OrderService {
